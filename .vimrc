...
nmap <silent> <F8> <ESC>:!ctags -R <CR><CR>
...
let g:ctrlp_custom_ignore = {
  \ 'dir':  '\v[\/]\.(git|hg|svn)$',
  \ 'file': '\v\.(exe|so|dll|o|cmd|tar|zip)$',
...
" my help
" nmap vmap imap cmap... the n,v,i,c point the map only valid in normal or visual mode
" nnoremap vnoremap... the noremap means no recursion, if map Y -> y, then map
" y -> Y, it will cause recursion.
"
"
set nu
set hlsearch
...
" 
" 
set grepprg=/bin/grep\ -nsr\ --binary-files=without-match\ 
" 可视模式下当前文本中搜索选中部分
